...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Volt::route('professionals', 'pages.professionals.index')->name('professionals.index'); // Adicionado o ";" aqui
    Volt::route('commands', 'pages.commands.index')->name('commands.index'); // Corrigido para apenas um ";"
